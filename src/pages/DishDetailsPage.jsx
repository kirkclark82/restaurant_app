        ...
        <main className="dish-details__main">
          <div className="dish-details__grid">
            ...
            <div className="dish-details__image-container">
              ...
              {/* Price Badge */}
              <div className="dish-details__price-badge">
                <span className="dish-details__price-badge-text">${dish.price}</span>
              </div>

              {/* Category Badge */}
              <div className="dish-details__category-badge">
                <i className={`${getCategoryIcon(dish.category)} dish-details__category-icon`}></i>
                <span className="dish-details__category-text">{dish.category}</span>
              </div>
            </div>
